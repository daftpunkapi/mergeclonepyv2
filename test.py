...
FIELDS_OF_INTEREST = ["id", "fields.parent.id" , "fields.assignee.displayName", "fields.duedate", "fields.status.name", "CommonStatus", "fields.priority.name", "fields.issuetype.name", "fields.description"]
